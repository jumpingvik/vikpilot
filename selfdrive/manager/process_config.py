...
procs = [
  ...
  PythonProcess("dmonitoringmodeld", "selfdrive.modeld.dmonitoringmodeld", False, enabled=(not PC or WEBCAM)),
  NativeProcess("encoderd", "system/loggerd", ["./encoderd"], False),
  ...
  PythonProcess("dmonitoringd", "selfdrive.monitoring.dmonitoringd", False, enabled=(not PC or WEBCAM)),
  ...
  PythonProcess("statsd", "selfdrive.statsd", False),
