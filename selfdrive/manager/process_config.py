...
procs = [
  ...
  PythonProcess("dmonitoringmodeld", "selfdrive.modeld.dmonitoringmodeld", enable_logging, enabled=(not PC or WEBCAM)),
  ...
  PythonProcess("dmonitoringd", "selfdrive.monitoring.dmonitoringd", enable_logging, enabled=(not PC or WEBCAM)),
